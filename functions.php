...
function wptest_scripts() {
	...
	wp_enqueue_style( 'wptest-main-style', get_template_directory_uri() . '/css/main.min.css', array(), '1.0', false );
	wp_enqueue_style( 'google-fonts', 'https://fonts.googleapis.com/css2?family=Nunito&family=Poppins:wght@400;500;600;700&display=swap', false );
	wp_enqueue_script('jquery');
	wp_enqueue_script( 'wptest-scripts', get_template_directory_uri() . '/js/main.js', array(), '20151215', true );
	wp_enqueue_script( 'font-awesome', 'https://kit.fontawesome.com/b5d863fae4.js', true );
